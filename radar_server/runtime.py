...
class RadarRuntime:
    ...
    def __init__(
        ...
        *,
        ...
        self.render_worker = RenderWorker(self.render_queue, want_board=self.want_board)
    ...
    def shutdown(self, *, join_timeout_seconds: float = 10.0) -> None:
        ...
        for worker in (self.download_worker, self.render_worker):
            if worker.is_alive():
...
def run_forecasts_once(config: RadarServerConfig, *, now: datetime | None = None) -> int:
